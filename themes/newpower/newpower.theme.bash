...
. "$BASH_IT/themes/newpower/newpower.base.bash"

USER_INFO_SSH_CHAR=${POWERLINE_USER_INFO_SSH_CHAR:="⌁ "}
USER_INFO_THEME_PROMPT_COLOR=45
USER_INFO_THEME_PROMPT_COLOR_SUDO=216
...
SCM_THEME_PROMPT_CLEAN_COLOR=117
SCM_THEME_PROMPT_DIRTY_COLOR=197
SCM_THEME_PROMPT_STAGED_COLOR=72
SCM_THEME_PROMPT_UNSTAGED_COLOR=207
...
LAST_STATUS_THEME_PROMPT_COLOR=199
